...
SWIFT_CLASS("_TtC17animationCircular11AppDelegate")
...
SWIFT_CLASS("_TtC17animationCircular18CircularTransition")
...
@interface CircularTransition (SWIFT_EXTENSION(animationCircular)) <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC17animationCircular14ViewController")
...
SWIFT_CLASS("_TtC17animationCircular20secondViewController")
@interface secondViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified dismissButton;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)dismissSecondVC:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
